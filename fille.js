...
buttons.forEach(function(button) {
    button.addEventListener('click', function() {
        // Récupérez le nom du patient à partir de la classe patient-name dans la même ligne
        var nomPatient = this.closest('tr').querySelector('.patient-name').textContent;
        
        // Affichez le nom du patient dans une alerte (vous pouvez changer cela selon vos besoins)
        alert("Détails pour " + nomPatient);
    });
});
